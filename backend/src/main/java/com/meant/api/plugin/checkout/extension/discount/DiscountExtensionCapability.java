...
@Component
public class DiscountExtensionCapability implements UcpCapability<Void, Void> {

    public static final CapabilityId ID = DiscountExtensionSupport.ID;
    ...
    public List<CapabilityAdvertisement> advertisements() {
        return List.of(CheckoutCapabilityMetadata.optionalExtension(
                ...
                "discount",
                "discount.json",
                List.of(CheckoutCapabilityMetadata.CHECKOUT, CheckoutCapabilityMetadata.CART)
        ));
    }
