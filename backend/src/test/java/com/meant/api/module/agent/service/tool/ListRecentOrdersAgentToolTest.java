...
class ListRecentOrdersAgentToolTest {
    ...
    void injectsTheContextUserAndDoesNotExposeUserIdInTheSchema() {
        ...
        AgentJsonSupport json = new AgentJsonSupport(new ObjectMapper(), properties());
        StubOrderService orderService =
                new StubOrderService(new OrderListResult(List.of(), 0, 5, false));
        ...
        assertThat(orderService.query.limit()).isEqualTo(5);
    ...
    @Test
    void exposesTheOfficialMerchantAsMerchantOriginInResultsAndArtifacts() throws Exception {
        UUID userId = UUID.fromString("00000000-0000-0000-0000-000000000111");
        ...
        OrderSummaryResult order = new OrderSummaryResult(
                orderId,
        ...
        StubOrderService orderService =
                new StubOrderService(new OrderListResult(List.of(order), 0, 10, false));
        ListRecentOrdersAgentTool tool = new ListRecentOrdersAgentTool(json, orderService);
        ...
        assertThat(objectMapper.readTree(buyerResultJson).at("/orders/0/merchantOrigin").asText())
    ...
    private static final class StubOrderService extends OrderService {
        ...
        private final OrderListResult result;
        private ListOrdersQuery query;

        private StubOrderService(OrderListResult result) {
