...
class AgentContextAssemblerTest {
    ...
    void laterRunReceivesOrderedTurnsNumberedProductsAndOnlyTheCurrentCartLines() {
        ...
        assertThat(systemPrompt)
                ...
                .contains("Add only the returned selectedOfferKey when exactMatch and")
                .contains("cartable are true;")
                .contains("cart mutations enforce this server-issued current-run selection proof")
                .contains("do not change the cart, substitute another variant")
                .contains("When the user asks to checkout, proceed to checkout, or start checkout")
                .contains("call prepare_checkout")
                .contains("Use get_checkout to inspect")
                .contains("automatically reuses the authenticated user's saved contact")
                .contains("savedCheckoutDetailsAutoApplied")
                .contains("do not ask the user to provide them again")
                .contains("Use update_checkout")
