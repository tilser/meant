...
class AgentContextAssemblerTest {
    ...
    void laterRunReceivesOrderedTurnsNumberedProductsAndOnlyTheCurrentCartLines() {
        ...
        assertThat(systemPrompt)
                ...
                .contains("football boots normally needs the buyer's size and shipping destination")
                .contains("call get_user_preferences")
                .contains("For food, never ask for size")
