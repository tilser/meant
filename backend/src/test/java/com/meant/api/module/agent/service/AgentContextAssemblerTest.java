...
class AgentContextAssemblerTest {
    ...
    void laterRunReceivesOrderedTurnsNumberedProductsAndOnlyTheCurrentCartLines() {
        ...
        assertThat(systemPrompt)
                ...
                .contains("call select_product_variant with the")
                .contains("complete combination")
                .contains("Add only its returned selectedOfferKey when exactMatch and")
                .contains("cartable are true; cart mutations enforce this server-issued current-run selection proof")
