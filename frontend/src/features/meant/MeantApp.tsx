...
import { ProductCard, ProductPriceLine } from './product/ProductCard'
...
import type { AskPanelSize } from './ask/types'
import type { ProductOpenProps, ProductSaveProps } from './product/types'
import {
  productCuratedAdvantages,
  productCuratedFields,
  productCuratedTake,
  productCuratedTradeoffs,
  productWithCuratedFields,
} from './product/productCuration'
